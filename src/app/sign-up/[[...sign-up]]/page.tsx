        ...
        <div className="w-full max-w-md text-center">
          ...
          >
            ...
            <p className="text-sm mb-6" style={{ color: "var(--color-text-muted)" }}>
              Sign-up requires Clerk credentials. Add your{" "}
              <code
              ...
              to <code className="text-xs px-1.5 py-0.5 rounded font-mono" style={{ background: "var(--color-surface-elevated)", color: "var(--color-primary)" }}>.env.local</code> to enable accounts.
            </p>
            <Link
              href="/"
